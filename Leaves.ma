...
//Name: Leaves.ma
//Last modified: Wed, Sep 11, 2019 08:56:25 PM
//Codeset: 1252
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -3.2990061645080582 8.8810987674052146 10.638011669345897 ;
	setAttr ".r" -type "double3" -39.338352729929184 -5.00000000000004 -1.9954399272777748e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "DFA6CA2C-4ABC-1C78-7854-D5A64538A3C4";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 14.012007231472047;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "006BDB8A-4BFE-D42C-5AB9-F4A19A194BF6";
	setAttr -s 7 ".lnk";
	setAttr -s 7 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "3013FEC2-46AF-4400-5EB4-F58C30B7BD4D";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "550607D1-4691-790C-FC6C-37BCDDD5B791";
createNode displayLayerManager -n "layerManager";
	rename -uid "72DE4E71-4959-AD64-F709-88B18F28B298";
createNode displayLayer -n "defaultLayer";
	rename -uid "93D3C2FF-46F2-D4CB-FD47-0E86E62390BA";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "4033E1E3-46B7-DB51-66AE-5085412C5FED";
...
createNode file -n "file1";
	...
	setAttr ".ftn" -type "string" "F:/GIT/FBX/Textures/Leaves2/leaves_basecolor.png";
...
createNode file -n "file5";
	...
	setAttr ".ftn" -type "string" "F:/GIT/FBX/Textures/Leaves2/Leaves_v3_basecolor.png";
	setAttr ".cs" -type "string" "sRGB";
createNode place2dTexture -n "place2dTexture5";
	rename -uid "F7D8D27B-40AD-2347-06DB-97A6FD6CBF3A";
createNode file -n "file6";
	rename -uid "E233E08E-483E-485A-F0AA-2280C86E5819";
	setAttr ".ftn" -type "string" "F:/GIT/FBX/Textures/Leaves2/Leaves_v3_opacity.png";
	setAttr ".cs" -type "string" "sRGB";
createNode place2dTexture -n "place2dTexture6";
	rename -uid "DDE14281-4AB7-1C87-505B-42988409AFFA";
createNode file -n "file7";
	rename -uid "5ECBF4C6-4DEB-3B18-118F-768E895B1F8E";
	setAttr ".ftn" -type "string" "F:/GIT/FBX/Textures/Leaves2/Leaves_v3_ambientOcclusion.png";
	setAttr ".cs" -type "string" "sRGB";
...
createNode file -n "file13";
	...
	setAttr ".ftn" -type "string" "F:/GIT/FBX/Textures/CloverWeed/Weeds_v2_basecolor.png";
	setAttr ".cs" -type "string" "sRGB";
...
createNode file -n "file16";
	...
	setAttr ".ftn" -type "string" "F:/GIT/FBX/Textures/Ground/stylized_forest_floor_basecolor.png";
	setAttr ".cs" -type "string" "sRGB";
