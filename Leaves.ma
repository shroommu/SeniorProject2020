...
//Name: Leaves.ma
//Last modified: Wed, Sep 04, 2019 10:47:58 AM
//Codeset: 1252
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -4.5178156474108846 5.60905596866463 9.2239902383853067 ;
	setAttr ".r" -type "double3" -25.538352729871892 -11.399999999993675 4.0557077008446108e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "DFA6CA2C-4ABC-1C78-7854-D5A64538A3C4";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 10.845801160127117;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "579897FA-4CF1-E21E-4A10-3BB4E0F3813C";
	setAttr -s 5 ".lnk";
	setAttr -s 5 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "158DD5ED-4201-1446-4902-E98E9582AC96";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "680D4F63-487D-40BB-5EE7-26A74BEF176D";
createNode displayLayerManager -n "layerManager";
	rename -uid "FAC9DDB4-4982-A795-02E7-B99394DDEB53";
createNode displayLayer -n "defaultLayer";
	rename -uid "93D3C2FF-46F2-D4CB-FD47-0E86E62390BA";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "42FF1DC3-4819-6946-3361-F79D64316BEA";
